    ...
    <div class="bg-blue-300 min-h-full p-4 flex flex-col items-center justify-start">
        ...
        <form action="{{ route('items.store') }}" method="post" class="w-full max-w-4xl bg-white p-6 rounded-lg shadow-md mt-4">
            ...
            <div class="flex flex-col mb-4">
                <label style="font-size: 18px; font-weight: bold" for="id_champs">{{ __('messages.selectCampeonItems') }}</label>
            ...
            <!-- Selección de Objeto -->
            <div class="flex flex-col mb-4">
                <label style="font-size: 18px; font-weight: bold" for="name">{{ __('messages.selectObjetoItems') }}</label>
